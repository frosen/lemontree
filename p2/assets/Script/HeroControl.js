...
cc.Class({
    ...
    update: function (dt) {
        let realSpeedY = this.speed.y;
        if (this.collisionY === 0) {
            this.speed.y += this.gravity * dt;
            realSpeedY = this.speed.y;
            if (Math.abs(this.speed.y) > this.maxSpeed.y) {
                realSpeedY = this.speed.y > 0 ? this.maxSpeed.y : -this.maxSpeed.y;
            }
        }
        ...
        if (this.direction === 0) {
            ...
            this.speed.x = this.direction > 0 ? this.maxSpeed.x : -this.maxSpeed.x;
        }
        ...
        this.preStep.y = realSpeedY * dt;
        
        this.node.x += this.speed.x * dt;
        this.node.y += realSpeedY * dt;
    },
});
