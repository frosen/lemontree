...
if (Array.isArray(b)) {
b[0] === b[1] && b[2] === b[3] ? f.types.push(l.Linear) : f.types.push(l.Bezier(b));
continue;
}
}
...
var C = c.events;
if (C) for (var T, E = 0, b = C.length; E < b; E++) {
if (!T) {
(T = new d()).target = i;
a.push(T);
}
...
g && (v = r(v, g));
var m = s[h];
d ? l = u + (m - u) * v : f && (l = u.lerp(m, v));
} else l = u;
} else l = s[h];
var y = this.subProps;
if (y) {
for (var C = this.target[this.prop], T = C, E = 0; E < y.length - 1; E++) {
var b = y[E];
if (!T) return;
T = T[b];
}
...
V = (T - 1) * (z = M.beziers[M.beziers.length - 1]).getLength();
...
f[f.length - 1] !== g[g.length - 1] && a(u[u.length - 1], m, f[f.length - 1]);
} else e.values = u;
}
...
var s = i("./utils/prefab-helper"), c = i("./utils/scene-graph-helper"), a = i("./event-manager"), l = cc.Object.Flags.Destroying, h = "position-changed", u = "size-changed", d = "anchor-changed", f = "rotation-changed", _ = "scale-changed", p = i("./utils/misc"), g = i("./event/event"), v = !!cc.ActionManager, m = function() {}, y = cc.Enum({
...
}), C = [ y.TOUCH_START, y.TOUCH_MOVE, y.TOUCH_END, y.TOUCH_CANCEL ], T = [ y.MOUSE_DOWN, y.MOUSE_ENTER, y.MOUSE_MOVE, y.MOUSE_LEAVE, y.MOUSE_UP, y.MOUSE_WHEEL ], E = null, b = function(t, e) {
...
E.dispatchEvent(t);
E._mouseListener._previousIn = !1;
}
E = this.owner;
...
cc.js.getset(w.prototype, "_sgNode", (function() {
...
p.propertyDefine(w, [ "parent", "tag", "skewX", "skewY", "position", "rotation", "rotationX", "rotationY", "scale", "scaleX", "scaleY", "opacity", "color" ], {
...
var a = n(i), f = i._anchorPoint, _ = i instanceof cc.Scene, p = t._position.x, g = t._position.y, v = t._anchorPoint;
if (e._alignFlags & l) {
var m, y, C = a.width;
if (_) {
...
var f = d + h * u - h * this.spacingX, _ = 0, p = 0, g = 0, v = 0, m = 0, y = 0, C = this.cellSize.width;
...
var f = d + h * u - h * this.spacingY, _ = 0, p = 0, g = 0, v = 0, m = 0, y = 0, C = this.cellSize.height;
...
if (o.complete || o.content) o.error ? cc._throw(o.error) : m.call(v, o); else {
var y = a.getQueue(o), C = y._callbackTable[d];
C ? C.unshift(m, v) : y.addListener(d, m, v);
}
}
}
cc.deserialize.Details.pool.put(n);
...
}), g = c.createInvokeImpl("c.__preload();"), v = c.createInvokeImpl(_), m = new l.Pool(4);
m.get = function() {
var t = this._get() || {
preload: new p(g),
...
var c = i("../assets/CCAsset"), a = i("./utils").callInNextTick, l = i("../load-pipeline/CCLoader"), h = i("../load-pipeline/pack-downloader"), u = i("../load-pipeline/auto-release-utils"), d = i("../utils/decode-uuid"), f = i("../load-pipeline/md5-pipe"), _ = "", p = "", g = {}, v = {
...
var d = r[u];
for (var v in d) {
var m = d[v], y = m[0], C = m[1], T = cc.js._getClassById(C);
if (T) {
g[v] = new s(u + "/" + y, T);
if ("assets" === u && y.startsWith(a)) {
if (cc.isChildClassOf(T, c)) {
var E = cc.path.extname(y);
y = E ? y.slice(a.length, -E.length) : y.slice(a.length);
} else y = y.slice(a.length);
var b = 1 === m[2];
o.add(y, v, T, !b);
}
...
if (r) {
0;
for (var h = m(t, n, e, i, !0), u = 0; u < h.length; u++) E.attr(t, i, h[u]);
h.length = 0;
E.setClassAttr(t, i, "serializable", !1);
0;
o || y.get(c, i, r, l, l);
0;
}
...
y.value(s, "__ctors__", o.length > 0 ? o : null, !0);
var u = s.prototype;
if (e) {
if (!l) {
y.extend(s, e);
...
v._isCCClass(f) && h(E.getClassAttrs(s).constructor.prototype, E.getClassAttrs(f).constructor.prototype);
}
u.constructor = s;
}
l || (u.__initProps__ = _);
...
function d(i) {
for (var n = y.getClassName(i), o = i.constructor, r = "new " + n + "(", s = 0; s < o.__props__.length; s++) {
...
var c = n[s], a = c + b + "default";
if (a in i) {
var l;
l = I.test(c) ? "this." + c + "=" : "this[" + f(c) + "]=";
var h, u = i[a];
...
function m(i, n, o, r, s) {
function c() {
h = r + b;
return l = E.getClassAttrsProto(i);
}
function a(i, o) {
if (i in n) {
var r = n[i];
...
if (f) u.push({
type: d,
_onAfterProp: S(f, "cc." + d)
}); else if ("Object" === d) 0; else if (d === E.ScriptUuid) {
var _ = E.ObjectType(cc.ScriptAsset);
_.type = "Script";
u.push(_);
...
y.setClassName(t, e);
for (var n = e.__props__ = Object.keys(i), o = E.getClassAttrsProto(e), r = 0; r < n.length; r++) {
var s = n[r];
o[s + b + "visible"] = !1;
o[s + b + "default"] = i[s];
}
...
i("./CCClass");
var _ = i("./preprocess-class"), p = i("./js"), g = "__ccclassCache__", v = a.bind(null, !1), m = l(), y = l(), C = c((function(t, e) {
var i = p.getSuper(t);
i === Object && (i = null);
var n = {
name: e,
...
var v = r.OS_UNKNOWN;
-1 !== c.appVersion.indexOf("Win") ? v = r.OS_WINDOWS : f ? v = r.OS_IOS : -1 !== c.appVersion.indexOf("Mac") ? v = r.OS_OSX : -1 !== c.appVersion.indexOf("X11") && -1 === c.appVersion.indexOf("Linux") ? v = r.OS_UNIX : d ? v = r.OS_ANDROID : -1 === c.appVersion.indexOf("Linux") && -1 === h.indexOf("ubuntu") || (v = r.OS_LINUX);
r.os = v;
r.osVersion = _;
r.osMainVersion = p;
...
b.textContent = "body,canvas,div{ -moz-user-select: none;-webkit-user-select: none;-ms-user-select: none;-khtml-user-select: none;-webkit-tap-highlight-color:rgba(0,0,0,0);}";
}
try {
var S = r.localStorage = s.localStorage;
S.setItem("storage", "");
...
r.os === r.OS_IOS && (w.USE_LOADER_EVENT = "loadedmetadata");
if (r.browserType === r.BROWSER_TYPE_FIREFOX) {
w.DELAY_CREATE_CTX = !0;
w.USE_LOADER_EVENT = "canplay";
}
r.os === r.OS_ANDROID && r.browserType === r.BROWSER_TYPE_UC && (w.ONE_SOURCE = !0);
!1;
})();
try {
if (w.WEB_AUDIO) {
w.context = new (window.AudioContext || window.webkitAudioContext || window.mozAudioContext)();
w.DELAY_CREATE_CTX && setTimeout((function() {
w.context = new (window.AudioContext || window.webkitAudioContext || window.mozAudioContext)();
}), 0);
}
} catch (t) {
...
s.DELIMETER + "serializable"), d = s.DELIMETER + "default", f = s.DELIMETER + "saveUrlAsAsset", _ = s.DELIMETER + "formerlySerializedAs", p = s.getClassAttrs(n), g = n.__props__, v = [ "var prop;" ], m = a.BUILTIN_CLASSID_RE.test(r._getClassId(n)), y = 0; y < g.length; y++) {
var C, T = g[y];
if (p[T + h]) {
...
var i;
this.globalVariables.length > 0 && (i = b + this.globalVariables.join(",") + ";");
...
return b + this.varName + "=" + this.expression + ";";
};
...
if ("string" === ("object" == (e = typeof o) ? t(o) : e)) return E(o);
...
e = new r(S, "new " + this.getFuncModule(i, !0) + "()");
} else if (i === Object) e = new r(S, "{}"); else {
if (i) return this.getObjRef(t);
e = new r(S, "Object.create(null)");
}
var n = [ e ];
t._iN$t = {
globalVar: "",
...
cc.js), _ = h.Destroying, p = h.DontDestroy, g = new d("Node"), v = cc.Class({
name: "cc._BaseNode",
extends: cc.Object,
mixins: [ cc.EventTarget ],
properties: {
...
var v = c[t], m = this._sgNode.getLayer(v), y = g.indexOf(v);
if (y < 0) {
...
C && T || cc.errorID(7202);
T._replaceSgNode(m);
C.setSiblingIndex(m.getLocalZOrder());
...
v = a[t];
var b = this._sgNode.getObjectGroup(v);
if ((y = E.indexOf(v)) < 0) {
var S = null;
if ((C = this.node.getChildByName(v)) && !C.getComponent(cc._SGComponent)) S = C.addComponent(cc.TiledObjectGroup); else {
C = new cc.Node(v);
this.node.addChild(C);
S = C.addComponent(cc.TiledObjectGroup);
}
C && S || cc.errorID(7202);
S._replaceSgNode(b);
C.setSiblingIndex(b.getLocalZOrder());
C.setAnchorPoint(this.node.getAnchorPoint());
